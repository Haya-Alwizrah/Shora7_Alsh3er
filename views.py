...
.muallaqat-item { display:flex; align-items:center; gap:10px; padding:10px 14px; background:#F9F6EE; border:0.5px solid #E2D9C4; border-radius:10px; }
...
def render_details():
    ...
    <div class="content-card">
      ...
      <div class="muallaqat-grid">
        ...
        <div class="muallaqat-item"><div class="m-avatar" style="background:#E1F5EE;color:#04342C">طر</div><div><div class="m-name">معلقة طرفة بن العبد</div><div class="m-desc">لخولةَ أطلالٌ ببُرقة ثهمد</div></div></div>
        <div class="muallaqat-item"><div class="m-avatar" style="background:#FAEEDA;color:#412402">زه</div><div><div class="m-name">معلقة زهير بن أبي سُلمى</div><div class="m-desc">أمن أم أوفى دمنةٌ لم تكلّم</div></div></div>
        <div class="muallaqat-item"><div class="m-avatar" style="background:#E6F1FB;color:#042C53">لب</div><div><div class="m-name">معلقة لبيد بن ربيعة</div><div class="m-desc">عفت الديارُ محلُّها فمقامُها</div></div></div>
        <div class="muallaqat-item"><div class="m-avatar" style="background:#FCEBEB;color:#501313">عن</div><div><div class="m-name">معلقة عنترة بن شداد</div><div class="m-desc">هل غادر الشعراءُ من مُتردَّم</div></div></div>
        <div class="muallaqat-item"><div class="m-avatar" style="background:#EAF3DE;color:#173404">حا</div><div><div class="m-name">معلقة الحارث بن حلزة</div><div class="m-desc">آذنتنا ببينها أسماءُ</div></div></div>
        <div class="muallaqat-item"><div class="m-avatar" style="background:#FBEAF0;color:#4B1528">عم</div><div><div class="m-name">معلقة عمرو بن كلثوم</div><div class="m-desc">ألا هُبّي بصحنِك فاصبحينا</div></div></div>
        <div class="muallaqat-item"><div class="m-avatar" style="background:#FEF4E0;color:#412402">أع</div><div><div class="m-name">معلقة الأعشى</div><div class="m-desc">ودّع هُريرةَ إنّ الرَّكبَ مُرتحلُ</div></div></div>
        <div class="muallaqat-item"><div class="m-avatar" style="background:#E6F1FB;color:#042C53">نا</div><div><div class="m-name">معلقة النابغة الذبياني</div><div class="m-desc">يا دارَ ميّةَ بالعلياء فالسَّند</div></div></div>
        <div class="muallaqat-item"><div class="m-avatar" style="background:#EDE8F5;color:#26215C">عب</div><div><div class="m-name">معلقة عبيد بن الأبرص</div><div class="m-desc">أقفرَ من أهله مَلحوبُ</div></div></div>
      </div>
    </div>
    """, unsafe_allow_html=True)
    ...
    with col1:
        ...
        <div class="content-card">
          ...
          <div class="tech-row"><span class="tech-lbl">Embedding Model</span><span class="tech-val">SarahALo/Arabic_embed_model</span></div>
          <div class="tech-row"><span class="tech-lbl">LLM</span><span class="tech-val">GPT-4o mini</span></div>
        </div>
        """, unsafe_allow_html=True)
    with col2:
        st.markdown("""
        <div class="content-card">
          <h3>⚙️ البنية التحتية</h3>
          <div class="tech-row"><span class="tech-lbl">Vector DB</span><span class="tech-val">ChromaDB</span></div>
          <div class="tech-row"><span class="tech-lbl">Graph DB</span><span class="tech-val">Neo4j AuraDB</span></div>
        </div>
        """, unsafe_allow_html=True)
    ...
    <div class="content-card">
      ...
      <div style="display:flex;gap:16px;flex-wrap:wrap;">
        <div style="flex:1;display:flex;align-items:center;gap:14px;padding:16px;background:#F9F6EE;border-radius:12px;border:0.5px solid #E2D9C4">
          <div class="avatar av2">SA</div><div><b>Sarah ALowjan</b></div>
        </div>
        <div style="flex:1;display:flex;align-items:center;gap:14px;padding:16px;background:#F9F6EE;border-radius:12px;border:0.5px solid #E2D9C4">
          <div class="avatar av1">HA</div><div><b>Haya Alwizrah</b></div>
        </div>
      </div>
    </div>
    """, unsafe_allow_html=True)